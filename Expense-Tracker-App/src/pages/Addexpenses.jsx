...
const Addexpenses = () => {
  ...
  return (
    <div
      className="flex flex-col  items-center w-[100vw] min-h-[85vh]"
      id="container"
    >
      <h1 className="text-center text-5xl mb-6 font-bold mt-[10vh]">
        Add Expenses
      </h1>
      <form
        className="flex flex-col items-center bg-[#a7c6ed] 
      ...
      >
        <div id="input-grid" className="grid grid-cols-2 gap-4 gap-y-6 p-2  ">
          <div className="flex gap-2">
            <label className="" htmlFor="expense">
              Expense
            </label>
            <input
              className="focus:outline-none  focus:ring-indigo-600 
        ...
        focus:ring-2 rounded"
          ...
          focus:ring-2 rounded"
            ...
            >
              {" "}
              {/*do it dynamically using array of catgories */}
        ...
        <button
          className="mt-10 rounded bg-[#7950f2] hover:bg-indigo-400 p-1 px-2 text-white "
          type="submit"
        >
          Add Expense
        </button>
