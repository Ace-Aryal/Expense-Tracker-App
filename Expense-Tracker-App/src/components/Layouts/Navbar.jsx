      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 sticky">
        <div className="relative flex h-16 items-center justify-between">
                ...
                {navigation.map((item) => (
                  <NavLink
                    ...
                    className={ ({isActive})=> classNames(
                      isActive ? 'bg-indigo-500 text-white' : 'text-gray-800 hover:bg-gray-700 hover:text-white',
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            {/* Profile dropdown */}
            <div className='bg-indigo-400 p-2 rounded-xl text-white shadow-gray-500 '>Balance: ${balance}</div>
